...
h2o.init()
nnmodel<-h2o.loadModel("/home/gayatri/Fortiate/Build/Workspaces/R/Models/DeepLearning_model_R_1571115759676_2")
consumer=rkafka.createConsumer("127.0.0.1:2181","rupay-generated-data",autoOffsetReset="smallest",groupId = "gredh")
